...
//基础组件写法
function Component(){
	return <h1>I am purain</h1>
}

class ES6Component extends React.Component{
	render(){
		return <h1>I am purain in ES6</h1>
	}
}
	...
	render(){
		return (
			<div>
				...
				<button onClick={this.handleClick}>add one age</button>
			</div>
		)
	}
}
	...
	render(){
		return (
			<div>
				<h1>I am {this.state.name}</h1>
				<p>I am {this.state.age} years old!</p>
				<button onClick={(e)=>{this.handleClick(e)}}>add one age</button>
	...
	render(){
		return (
			<div>
				...
				<button onClick={(e)=>{this.handleClick(e)}}>change bgColor</button>
			</div>
		)
	}
}
	...
	render(){
		return (
			<div>
				...
				<button onClick={(e)=>{this.handleClick(e)}}>change Child2 bgColor</button>
			</div>
		)
	}
}
